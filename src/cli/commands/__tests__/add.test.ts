...
describe('addCommand', () => {
  ...
  it('should show error for invalid component', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Invalid component: invalid'));
  ...
  it('should handle errors when adding workflow', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Failed to add workflow'));
    expect(processSpy).toHaveBeenCalledWith(1);
  });
  ...
  it('should handle errors when adding hooks', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Failed to add hooks'));
    expect(processSpy).toHaveBeenCalledWith(1);
  });
